...
export default function MagicRings({
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      mount.removeEventListener('mousemove', onMouseMove); mount.removeEventListener('mouseenter', onMouseEnter);
      mount.removeEventListener('mouseleave', onMouseLeave); mount.removeEventListener('click', onClick);
      mount.removeChild(renderer.domElement); renderer.dispose(); material.dispose();
    };
  }, []);
  return <div ref={mountRef} style={{ width: '100%', height: '100%', display: 'block', ...(blur > 0 ? { filter: `blur(${blur}px)` } : {}) }} />;
}
