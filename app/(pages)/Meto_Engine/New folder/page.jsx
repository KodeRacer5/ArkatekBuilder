...
function MetaEngineNode({ data }) {
  ...
  return (
    <div style={{background:a?'rgba(255,255,255,0.06)':'var(--gb-bg-soft)',border:`2px solid ${a?'rgba(255,255,255,0.7)':'rgba(255,255,255,0.2)'}`,borderRadius:16,minWidth:200,padding:'14px 18px',boxShadow:a?'0 0 40px rgba(255,255,255,0.12),0 0 80px rgba(255,255,255,0.08)':'0 4px 20px rgba(0,0,0,0.5)',transition:'all 0.5s ease',textAlign:'center'}}>
...
// ─────────────────────────────────────────────────────────────────────────────
const iS = {background:'rgba(255,255,255,0.08)',border:'1px solid rgba(255,255,255,0.12)',borderRadius:6,color:'#fff',fontSize:11,padding:'5px 8px',width:'100%',outline:'none'}
