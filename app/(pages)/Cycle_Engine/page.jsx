          ...
          return (
            <div key={i} onClick={()=>day&&setSelectedDay(selectedDay===day?null:day)} className="nopan"
              style={{
                ...
                background:today?'rgba(250,189,47,0.07)':selectedDay===day?'rgba(235,219,178,0.05)':'rgba(255,255,255,0.025)',
                border:today?'1px solid rgba(250,189,47,0.45)':selectedDay===day?'1px solid rgba(235,219,178,0.18)':'1px solid rgba(235,219,178,0.07)',
                boxShadow:today?'0 4px 20px rgba(250,189,47,0.12),inset 0 1px 0 rgba(250,189,47,0.08)':'0 2px 8px rgba(0,0,0,0.25),inset 0 1px 0 rgba(235,219,178,0.04)',
...
function CycleDashboardNode({data,selected}){
  ...
  const drawAdh=useCallback((ctx,W,H)=>{if(!ctx||W<10||H<10)return
  ...
  const drawTm=useCallback((ctx,W,H)=>{if(!ctx||W<10||H<10)return
  ...
  const drawHist=useCallback((ctx,W,H)=>{if(!ctx||W<10||H<10)return
  ...
  const drawArea=useCallback((ctx,W,H)=>{if(!ctx||W<10||H<10)return
  ...
  const drawComp=useCallback((ctx,W,H)=>{if(!ctx||W<10||H<10)return
