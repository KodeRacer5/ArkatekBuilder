...
function Navbar({ className, ...props }: React.ComponentProps<'nav'>) {
  return (
    <nav
      data-slot="navbar"
      className={cn('flex items-center justify-between h-full overflow-visible', className)}
      {...props}
    />
  );
}
...
function NavbarLeft({ className, ...props }: React.ComponentProps<'nav'>) {
  return (
    <nav
      ...
      className={cn('flex items-center justify-start gap-4 flex-1', className)}
      {...props}
    />
  );
}
...
function NavbarRight({ className, ...props }: React.ComponentProps<'nav'>) {
  return (
    <nav
      ...
      className={cn('flex items-center justify-end gap-4 flex-1', className)}
      {...props}
    />
  );
}
